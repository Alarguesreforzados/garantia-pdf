...
// Recibe mensajes entrantes de WhatsApp via Twilio y los guarda en Supabase.
// Configurar esta URL (https://TU-APP.up.railway.app/whatsapp-webhook) como
// "When a message comes in" en la consola de Twilio (Sandbox o número de WhatsApp).
app.post('/whatsapp-webhook', async (req, res) => {
  try {
    ...
    if (error) console.error('Error guardando mensaje WhatsApp:', error.message);

    // No respondemos automáticamente al cliente, solo confirmamos a Twilio.
